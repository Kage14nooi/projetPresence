...
interface AppareilListProps {
  appareils: Appareil[];
  onEdit: (appareil: Appareil) => void;
  onDelete: (id: number) => void;
}

const AppareilList: React.FC<AppareilListProps> = ({
  appareils = [],
  onEdit,
  onDelete,
}) => {
  ...
  const appareilCount = appareils.length;

  // Filtrage
  const filtered = appareils.filter((a) =>
    a.appareil_nom.toLowerCase().includes(searchTerm.toLowerCase())
  );
      ...
      <div className="bg-white rounded-2xl shadow-xl mb-6 overflow-hidden flex-shrink-0">
        <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 p-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-blue-100">
                  ...
                  {searchTerm && `sur ${appareilCount} au total`}
                </p>
              </div>
            </div>
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Rechercher par nom d'appareil..."
              value={searchTerm}
              onChange={(e) => {
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex gap-2 pt-4 border-t border-gray-100">
                        ...
                        <button
                          onClick={() => onDelete(a.appareil_id!)}
                          className="flex-1 flex items-center justify-center px-4 py-2.5 
