...
// // Appareil
// // =========================
// const Appareil = sequelize.define(
//   "appareil",
//   {
//     appareil_id: {
//       type: DataTypes.INTEGER,
...
//       autoIncrement: true,
//     },
//     appareil_nom: DataTypes.STRING,
//     appareil_serie: DataTypes.STRING,
//   },
//   { timestamps: false }
// );
...
//     niveau_id: DataTypes.INTEGER,
//     role_id: DataTypes.INTEGER,
//     device_user_id: DataTypes.STRING,
//   },
//   { timestamps: false }
// );
...
//     },
//     matiere_nom: DataTypes.STRING,
//     professeur_id: { type: DataTypes.INTEGER },
//     parcours_id: DataTypes.INTEGER,
//     mention_id: DataTypes.INTEGER,
//     niveau_id: DataTypes.INTEGER,
//   },
...
// // appareil ---> séance
// Appareil.hasMany(Seance, {
//   foreignKey: "appareil_id",
//   onDelete: "SET NULL", // si un appareil est supprimé, on garde la séance mais sans appareil
//   onUpdate: "CASCADE",
// });

// Seance.belongsTo(Appareil, {
//   foreignKey: "appareil_id",
//   onDelete: "SET NULL",
//   onUpdate: "CASCADE",
// });

// // parcours /mention/niveau etudiant
...
// //parcour/mention/niveau --->matière
// Parcours.hasMany(Matiere, {
//   foreignKey: "parcours_id",
//   onDelete: "SET NULL",
//   onUpdate: "CASCADE",
// });
...
// Absence.hasMany(PieceJustificative, {
...
// // étudiant ---> notification

// Etudiant.hasMany(Notification, {
//   foreignKey: "etudiant_id",
//   onDelete: "CASCADE",
//   onUpdate: "CASCADE",
// });
...
// // étudiant/seance/matière ---> log appareil

// Etudiant.hasMany(LogAppareil, {
//   foreignKey: "etudiant_id",
//   onDelete: "SET NULL",
//   onUpdate: "CASCADE",
// });
...
const Seance = sequelize.define(
  "seance",
  {
    ...
    appareil_id: {
      type: DataTypes.INTEGER,
      allowNull: true,
      references: { model: Appareil, key: "appareil_id" },
    },
    date_seance: DataTypes.DATEONLY,
    heure_debut: DataTypes.TIME,
    heure_fin: DataTypes.TIME,
...
// Parcours/Mentions/Niveau -> Etudiant
Parcours.hasMany(Etudiant, {
  foreignKey: "parcours_id",
  onDelete: "SET NULL",
  onUpdate: "CASCADE",
...
// Parcours/Mentions/Niveau -> Matiere
Parcours.hasMany(Matiere, {
  foreignKey: "parcours_id",
  onDelete: "SET NULL",
  onUpdate: "CASCADE",
...
// Etudiant/Seance/Matiere -> LogAppareil
Etudiant.hasMany(LogAppareil, {
  foreignKey: "etudiant_id",
  onDelete: "SET NULL",
  onUpdate: "CASCADE",
